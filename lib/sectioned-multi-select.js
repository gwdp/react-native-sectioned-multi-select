...
class SectionedMultiSelect extends PureComponent {
  ...
  _displaySelectedItems = () => {
    ...
    return selectedItems.map((singleSelectedItem) => {
      ...
      if (!item || !item[chipKey]) return null
        ...
        >
          <this.BackdropView style={[{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)' }, styles.backdrop]}>
            ...
            >
              ...
              {!hideSearch &&
                <View style={[{ flexDirection: 'row', paddingVertical: 5, borderBottomWidth: 1, borderColor: '#C7CED5' }, styles.searchBar]}>
              ...
              <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#C7CED5' }}>
                {showCancelButton &&
                  <Touchable
